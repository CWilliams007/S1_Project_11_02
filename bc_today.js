...
*/
// sets var thisDate as current date
var thisDate = new Date();
// sets var datestring equal to thisDate after localizing its date
var dateString = thisDate.toLocaleString();
// sets DateHTML equal to a HTML text string with Datestring in the middle
var dateHTML = "<h2>" + dateString + "</h2>";
// gets the day from date 
var thisDay = thisDate.getDay();
// sets getevent function equal to the day, when eventhtml is triggered it is equal to the day of and gets that case value
